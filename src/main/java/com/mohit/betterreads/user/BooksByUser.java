...
public class BooksByUser {
    ...
    public String toString() {
        return "BooksByUser [id=" + id + ", bookId=" + bookId + ", timeUuid=" + timeUuid + ", readingStatus="
                + readingStatus + ", bookName=" + bookName + ", authorNames=" + authorNames + ", coverIds=" + coverIds
                + ", rating=" + rating + ", coverUrl=" + coverUrl + "]";
    }
